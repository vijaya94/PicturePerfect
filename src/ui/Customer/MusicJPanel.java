 ...
 */
public class MusicJPanel extends javax.swing.JPanel {

    /**
     * Creates new form MusicJPanel
     */
    JPanel rightJPanel;
    String username;
    int bookingId;
    ...
    public MusicJPanel(JPanel rightJPanel, String username, int bookingId) {
        initComponents();
        ...
        try {
                    ...
                    PreparedStatement st = connection.prepareStatement("Select vendor_id, vendor_name, concat(addr_line_1,\" \", addr_line_2) as address, email, phone_number, status from vendor_details where vendor_type_id=4 and registration_status=3");
                    ...
                    while(rs.next()){
                      ...
                      String tblData[] = {vendorId, vendorName, address, email, phnNumber, status};
                      DefaultTableModel tblModel = (DefaultTableModel)tblMusicVendors.getModel();
    ...
    private void initComponents() {
        ...
        tblMusicVendors = new javax.swing.JTable();
        ...
        btnMusicRequestToBook.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnMusicRequestToBookActionPerformed(evt);
            }
        });
        ...
        tblMusicVendors.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tblMusicVendors);
    ...
    private void btnMusicRequestToBookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMusicRequestToBookActionPerformed
        ...
        rowSelected = tblMusicVendors.convertRowIndexToModel(rowSelected);
        DefaultTableModel model = (DefaultTableModel) tblMusicVendors.getModel();
        ...
        tblMusicVendors.setRowSorter(tableRowSorter);
