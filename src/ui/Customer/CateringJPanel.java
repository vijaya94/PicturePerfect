...
public class CateringJPanel extends javax.swing.JPanel {
    ...
    int bookingId;
    Date bookingDate;
    public CateringJPanel() {
        initComponents();
    }

    public CateringJPanel(JPanel rightJPanel, String username, int bookingId, Date bookingDate) {
        initComponents();
    ...
    public void loadCaterers(){
            ...
            try {
                    ...
                    while(rs.next()){
                      ...
                      DefaultTableModel tblModel = (DefaultTableModel)tblCateringVendors.getModel();
    ...
    private void initComponents() {
        ...
        tblCateringVendors = new javax.swing.JTable();
        ...
        tblCateringVendors.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tblCateringVendors);
    ...
    private void btnVenueRequestToBookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenueRequestToBookActionPerformed
        int rowSelected = tblCateringVendors.getSelectedRow();
        if(rowSelected < 0){
            JOptionPane.showMessageDialog(this, "Select a record to request booking");
            return;
        }
        rowSelected = tblCateringVendors.convertRowIndexToModel(rowSelected);
        DefaultTableModel model = (DefaultTableModel) tblCateringVendors.getModel();
        ...
        try {
            ...
            if(rs.next()){
                ...
                if (returnedValue>0) {
                    ...
                    tblCateringVendors.setRowSorter(tableRowSorter);
    ...
    private javax.swing.JTable tblCateringVendors;
