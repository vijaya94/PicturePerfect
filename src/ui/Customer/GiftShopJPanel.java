 ...
 * @author nihar
 */
public class GiftShopJPanel extends javax.swing.JPanel {

    /**
     * Creates new form GiftShopJPanel
     */
    JPanel rightJPanel;
    String username;
    int bookingId;
    Date bookingDate;
    public GiftShopJPanel() {
        initComponents();
    }
    
    public GiftShopJPanel(JPanel rightJPanel, String username, int bookingId, Date bookingDate) {
        initComponents();
    ...
    public void loadGiftShops(){
        try {
                    Connection connection = (Connection) DBConnection.con();
                    // Get gift shop (id = 5) vendors where admin has approved registration
                    PreparedStatement st = connection.prepareStatement("Select vendor_id, vendor_name, concat(addr_line_1,\" \", addr_line_2) as address, email, phone_number from vendor_details where vendor_type_id=5 and registration_status=3");
                    ...
                    while(rs.next()){
                      ...
                      DefaultTableModel tblModel = (DefaultTableModel)tblGiftShopVendors.getModel();
    ...
    private void initComponents() {
        ...
        tblGiftShopVendors = new javax.swing.JTable();
        ...
        jLabel10.setText("Gift Shop Vendors");
        ...
        tblGiftShopVendors.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tblGiftShopVendors);
    ...
    private void btnVenueRequestToBookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenueRequestToBookActionPerformed
        int rowSelected = tblGiftShopVendors.getSelectedRow();
        if(rowSelected < 0){
            JOptionPane.showMessageDialog(this, "Select a record to request booking");
            return;
        }
        rowSelected = tblGiftShopVendors.convertRowIndexToModel(rowSelected);
        DefaultTableModel model = (DefaultTableModel) tblGiftShopVendors.getModel();
        ...
        try {
            ...
            if(rs.next()){
                ...
                if (returnedValue>0) {
                    ...
                    JOptionPane.showMessageDialog(this, "Gift shop is requested for registry");
                    
                    // reload grid
                    
                    TableRowSorter<DefaultTableModel> tableRowSorter = new TableRowSorter(model);
                    tblGiftShopVendors.setRowSorter(tableRowSorter);
...
username = null;
    ...
    private javax.swing.JTable tblGiftShopVendors;
