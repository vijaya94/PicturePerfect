...
public class VenueJPanel extends javax.swing.JPanel {
    ...
    public VenueJPanel() {
        ...
        try {
                    ...
                    PreparedStatement st = connection.prepareStatement("Select username, password from user_details where vendor_type_id=3 and registration_status=3");

                    ResultSet rs = st.executeQuery();
                    
                    while(rs.next()){
                      String vendorName = rs.getString("vendor_name");
                      String addrLine1 = rs.getString("addr_line_1");
                      String addrLine2 = rs.getString("addr_line_2");
                      String email = rs.getString("email");
                      String phnNumber = rs.getString("phone_number");
                      
                      String tblData[] = {vendorName, addrLine1, addrLine2, email, phnNumber};
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 160, 180, -1));
        ...
        tblVenueVendors.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(204, 102, 255), new java.awt.Color(204, 102, 255)));
        ...
        tblVenueVendors.setGridColor(new java.awt.Color(204, 102, 255));
        tblVenueVendors.setSelectionBackground(new java.awt.Color(204, 102, 255));
        tblVenueVendors.setSelectionForeground(new java.awt.Color(204, 102, 255));
