...
public class VenueJPanel extends javax.swing.JPanel {
    ...
    public VenueJPanel() {
        ...
        public VenueJPanel(JPanel rightJPanel, String username, int bookingId) {
        ...
        try {
                    ...
                    PreparedStatement st = connection.prepareStatement("Select vendor_id, vendor_name, concat(addr_line_1,\" \", addr_line_2) as address, email, phone_number, status from vendor_details where vendor_type_id=3 and registration_status=3");
    ...
    private void initComponents() {
        ...
        tblVenueVendors.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Vendor Id", "Name", "Full Address", "Email", "Phone Number", "Status"
            }
        ));
