 ...
 * @author nihar
 */
public class KidsEntertainmentJPanel extends javax.swing.JPanel {

    /**
     * Creates new form KidsEntertainmentJPanel
     */
    JPanel rightJPanel;
    String username;
    int bookingId;
    Date bookingDate;
    public KidsEntertainmentJPanel(JPanel rightJPanel, String username, int bookingId, Date bookingDate) {
        ...
        loadKidsEntertainmentGrid();
    }
    
    public void loadKidsEntertainmentGrid(){
        try {
                    Connection connection = (Connection) DBConnection.con();
                    // Get kids entertainment (id = 7) vendors where admin has approved registration
                    PreparedStatement st = connection.prepareStatement("Select vendor_id, vendor_name, concat(addr_line_1,\" \", addr_line_2) as address, email, phone_number from vendor_details where vendor_type_id=7 and registration_status=3");
                    ...
                    while(rs.next()){
                      ...
                      DefaultTableModel tblModel = (DefaultTableModel)tblEntertainmentVendors.getModel();
     ...
     public KidsEntertainmentJPanel(JPanel rightJPanel) {
        initComponents();
        this.rightJPanel = rightJPanel;
    }
    ...
    private void initComponents() {
        ...
        tblEntertainmentVendors = new javax.swing.JTable();
        ...
        jLabel10.setText("Kids Entertainment Vendors");
        ...
        tblEntertainmentVendors.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tblEntertainmentVendors);
    ...
    private void btnVenueRequestToBookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenueRequestToBookActionPerformed
        int rowSelected = tblEntertainmentVendors.getSelectedRow();
        if(rowSelected < 0){
            JOptionPane.showMessageDialog(this, "Select a record to request booking");
            return;
        }
        rowSelected = tblEntertainmentVendors.convertRowIndexToModel(rowSelected);
        DefaultTableModel model = (DefaultTableModel) tblEntertainmentVendors.getModel();
        ...
        try {
            ...
            if(rs.next()){
                ...
                st.setInt(2, 7); // kids entertainment is 3
                st.setInt(3, id);
                st.setInt(4, 1);
                ...
                if (returnedValue>0) {
                    ...
                    JOptionPane.showMessageDialog(this, "Kids Entertainer is requested");

                    TableRowSorter<DefaultTableModel> tableRowSorter = new TableRowSorter(model);
                    tblEntertainmentVendors.setRowSorter(tableRowSorter);
    ...
    private javax.swing.JTable tblEntertainmentVendors;
