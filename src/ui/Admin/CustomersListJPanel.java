...
public class CustomersListJPanel extends javax.swing.JPanel {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        try {
            ...
            if (userId > 0) {
                String updateTableSQL = "DELETE from user_details where username = ?;";
                ...
                if (returnedValue > 0) {
                    String updateTableSQL1 = "DELETE from booking_details where user_id = ?;";
                    PreparedStatement st1 = (PreparedStatement) connection.prepareStatement(updateTableSQL);
                    st1.setInt(1, userId);

                    int returnedValue1 = st.executeUpdate();
                    JOptionPane.showMessageDialog(this, "User and related bookings deleted");
                }
            }
        } catch (SQLException sqlException) {
            sqlException.printStackTrace();
    ...
    private void search(String str) {
        ...
        customerListTable.setRowSorter(tableRowSorter);
