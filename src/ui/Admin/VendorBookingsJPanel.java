...
public class VendorBookingsJPanel extends javax.swing.JPanel {
    ...
    public void loadGrid(){
        try {
            ...
            PreparedStatement st = connection.prepareStatement("SELECT concat(ud.first_name, \" \", ud.last_name) as name, bed.book_event_id, ol.org_type, vd.vendor_name, bd.booking_date, bd.special_request FROM booking_event_details bed inner join booking_details bd on bed.booking_id = bd.booking_id inner join organization_list ol on ol.org_id = bed.org_id inner join vendor_details vd on vd.vendor_id = bed.vendor_id inner join user_details ud on bd.user_id = ud.user_id  and bed.status IN (1,2,3,5);");
            ...
            while (rs.next()) {
                ...
                String tblData[] = {bookingId, orgType, vendorName, fullName, bookingDate, specialReq};
                DefaultTableModel tblModel = (DefaultTableModel) tblVendorBookings.getModel();
    ...
    private void initComponents() {
        ...
        tblVendorBookings = new javax.swing.JTable();
        ...
        tblVendorBookings.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Booking Id", "Vendor Type", "Vendor name", "Full Name", "Booking Date", "Special Request"
            }
        ));
        jScrollPane1.setViewportView(tblVendorBookings);
    ...
    private void search(String str) {
        DefaultTableModel model = (DefaultTableModel) tblVendorBookings.getModel();
        TableRowSorter<DefaultTableModel> tableRowSorter = new TableRowSorter(model);
        tblVendorBookings.setRowSorter(tableRowSorter);
    ...
    private javax.swing.JTable tblVendorBookings;
